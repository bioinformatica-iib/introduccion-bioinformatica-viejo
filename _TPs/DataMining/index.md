...
cd dataDataMining
wget https://raw.githubusercontent.com/bioinformatica-iib/introduccion-bioinformatica/master/_TPs/DataMining/data/maizeTranscDataMapped.csv
wget https://raw.githubusercontent.com/bioinformatica-iib/introduccion-bioinformatica/master/_TPs/DataMining/data/fibro.data
wget https://raw.githubusercontent.com/bioinformatica-iib/introduccion-bioinformatica/master/_TPs/DataMining/data/drug2.txt
wget https://raw.githubusercontent.com/bioinformatica-iib/introduccion-bioinformatica/master/_TPs/DataMining/data/drug1.txt
wget https://raw.githubusercontent.com/bioinformatica-iib/introduccion-bioinformatica/master/_TPs/DataMining/data/diauxic.txt
wget https://raw.githubusercontent.com/bioinformatica-iib/introduccion-bioinformatica/master/_TPs/DataMining/data/TablaEjemplo.txt
```
...
pueden seguir el [ejemplo de wikipedia](https://en.wikipedia.org/wiki/Complete-linkage_clustering) si no recuerdan el algoritmo.
   </li>
</ul>

Comparar gráficos y dendrogramas y discutir qué resultado (Norte o Sur) tiene más sentido biológico.

## Ejercicio 2: **Usando R**
...
2. A continuación vamos a utilizar la función `dist()` para calcular una matriz de distancias a partir de los datos de la tabla. Recordar que estos datos ya están cargados en una variable que se llama `MiTabla`. Podríamos haber usado cualquier nómbre (por ejemplo, "pepe"), y ustedes pueden cambiarlos cuando usen R por su cuenta.
...
Ahora vamos a estandarizar los datos de expresión disponibles para cada gen. De esta manera todos los valores de expresión se encontrarán en la misma escala y centrados en cero, tal como lo hicimos manualmente en el ejercicio anterior. R cuenta con la función `scale()` para estandarizar datos. 
...
* Compare los resultados, ¿difieren?
...
Luego de visualizar el nuevo dendrograma, de la misma forma que habíamos hecho antes. 

* Compare los resultados entre los datos crudos sin normalizar, normalizando y usando correlación, ¿encuentra alguno que difiere?
...
Observando el dendrograma de los datos estandarizados y el *heatmap*, podemos ver que hay dos grupos bien distinguibles de genes. Uno que aumenta su expresión a lo largo del tiempo y el otro que disminuye.

### Seleccionar grupos

9. Podemos cortar el árbol para quedarnos con estos dos grupos a cualquier altura entre ~1 y ~2.5, con la función `cutree()`...
...
Definamos una formula que calcule el conteo por millón:
